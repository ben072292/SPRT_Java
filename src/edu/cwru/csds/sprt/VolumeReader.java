...
public class VolumeReader {
	...
	public void dimensionParser(String line) {
		try {
			...
			if(array[0] == 0 || array[1] == 0 || array[2] == 0) throw new FileFormatNotCorrectException("Dimensions information in BOLD file cannot be 0");
			if(this.x == 0 && this.y == 0 && this.z == 0) {
				...
				if(this.x != array[0] || this.y != array[1] || this.z != array[2]) throw new FileFormatNotCorrectException("Dimensions information not consistent through all scans");
			}
		}catch (Exception e) {
			e.printStackTrace();
		}
