...
public class Matrix implements Serializable {
	...
	public Matrix multiply(Matrix matrix) {
		...
		cblas_dgemm(CblasRowMajor, CblasNoTrans, CblasNoTrans,
				this.row, matrix.col, this.col, alpha, this.array, this.col, matrix.array, matrix.col, beta, res.array,
				matrix.col);
		return res;
	}
	...
	public Matrix transposeMultiply(Matrix matrix) {
		...
		cblas_dgemm(CblasRowMajor, CblasTrans, CblasNoTrans,
				this.col, matrix.col, this.row, alpha, this.array, this.col, matrix.array, matrix.col, beta, res,
				matrix.col);
	...
	public Matrix multiplyTranspose(Matrix matrix) {
		...
		cblas_dgemm(CblasRowMajor, CblasNoTrans, CblasTrans,
				this.row, matrix.row, this.col, alpha, this.array, this.col, matrix.array, matrix.col, beta, res,
				matrix.row);
